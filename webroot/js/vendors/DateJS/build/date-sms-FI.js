...
Date.CultureStrings["sms-FI"] = {
        ...
        "nativeName": "s??m′?i?ll (L??′ddjannam)",
        "Sunday": "pa′sspei′vv",
        "Monday": "vu?ssargg",
        "Tuesday": "maaibargg",
        "Wednesday": "se?rad",
        ...
        "/sep(t(ember)?)?/": "??h(??m??n)?",
        "/oct(ober)?/": "k?lg(gm??n)?",
        "/nov(ember)?/": "ska(mm′m??n)?",
        "/dec(ember)?/": "rost(tovm??n)?",
        "/^su(n(day)?)?/": "^pa′sspei′vv",
        "/^mo(n(day)?)?/": "^vu?ssargg",
        "/^tu(e(s(day)?)?)?/": "^maaibargg",
        "/^we(d(nesday)?)?/": "^se?rad",
