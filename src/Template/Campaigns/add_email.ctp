...
?>
<?= $this->start('top_nav') ?>
    <span class="navbar-brand">发送邮件</span>
</div>
...
<div class="campaigns columns content">
    <div class="ui top attached tabular menu">
      <a class="<?php if (!isset($type) || $type== 'normal'): ?>active<?php endif ?> item" data-tab="normal">邮件群发</a>
      <a class="<?php if (isset($type) && $type== 'test'): ?>active<?php endif ?> item" data-tab="test">邮件测试</a>
    </div>
    <div class="ui bottom attached active tab segment" data-tab="normal">
        ...
        <fieldset>
            ...
            <?php
                echo $this->Form->control('subject', ['label' => '主題']);
    ...
    <div class="ui bottom attached tab segment" data-tab="test">
        ...
        <fieldset>
            <?php
                echo $this->Form->control('recipient', ['label' => '收件人']);
                echo $this->Form->control('subject', ['label' => '主題']);
                echo $this->Form->control('content', ['label' => '內容', 'required' => true, 'class' => 'editor', 'type' => 'textarea']);
            ?>
        </fieldset>
